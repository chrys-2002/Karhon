...
const REGLES: Regle[] = [
  ...
  },
  {
    ...
    reponse:
      "Vous pouvez nous joindre au +225 07 87 10 39 39, +225 05 76 36 72 72 ou +225 01 05 13 70 59, ou via la page Contact. Nous répondons à toutes vos questions.",
  },
  {
  ...
  },
  {
    ...
    reponse:
      "Nous sommes disponibles du lundi au vendredi. Pour un rendez-vous, appelez le +225 07 87 10 39 39, le +225 05 76 36 72 72 ou le +225 01 05 13 70 59, ou passez par la page Contact.",
  },
  {
  ...
  },
  {
    ...
    reponse:
      "Pour prendre rendez-vous avec un conseiller, appelez le +225 07 87 10 39 39, le +225 05 76 36 72 72 ou le +225 01 05 13 70 59, ou laissez vos coordonnées sur la page Contact. Nous revenons vers vous rapidement.",
  },
];
...
function genererReponse(message: string): string {
  ...
  return "Je n'ai pas la réponse précise à cette question, mais un conseiller KARHON Assurances se fera un plaisir de vous aider : +225 07 87 10 39 39, +225 05 76 36 72 72 ou +225 01 05 13 70 59, ou via la page Contact.";
}
